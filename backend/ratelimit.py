...
this single-process project doesn't otherwise need.

Per-process only: this resets on restart and isn't shared across workers
or instances -- documented in the README's limitations, same as this
project's other disclosed scope boundaries (e.g. the evaluation
framework's honesty about what it does and doesn't measure).
"""
