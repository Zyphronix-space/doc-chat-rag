    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
      <div className="w-full max-w-sm bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            <label htmlFor="login-email" className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">
              Email
            </label>
            <input
              id="login-email"
          ...
          <div>
            <label htmlFor="login-password" className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">
              Password
            </label>
            <input
              id="login-password"
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-4 text-center">
          No account?{' '}
          <Link to="/register" className="text-accent-600 dark:text-accent-400 font-medium">
            Register
          </Link>
        </p>
      </div>
